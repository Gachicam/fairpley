...
import { GlobalLocationForm } from "./global-location-form";
...
interface GlobalLocationListProps {
  locations: Location[];
}

export function GlobalLocationList({ locations }: GlobalLocationListProps): React.ReactElement {
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <DialogContent>
                ...
                {editingLocation && (
                  <GlobalLocationForm location={editingLocation} onSuccess={handleEditSuccess} />
                )}
              </DialogContent>
            </Dialog>
